...
const LandingNavbar = () => {
  ...
  return (
    <nav className='w-full py-6 flex justify-center fixed top-0 z-50'>
      <div className="rounded-full w-[350px] max-lg:w-[800px] max-[400px]:w-[345px] max-[450px]:w-[400px] max-[350px]:w-[330px] max-[321px]:w-[310px] px-2 py-1 bg-white/5 backdrop-blur-lg flex items-center justify-center dark:shadow-none">
